...
##Pooled Factor Analysis excluding personal threat questions
...
grizz_factor2<-grizz_factor[,-c(3:4)]
...
```{r, echo=FALSE}
grizz.pca2<-prcomp(grizz_factor2)
summary(grizz.pca2)
loadings<-grizz.pca2$rotation
scores<-grizz.pca2$x
